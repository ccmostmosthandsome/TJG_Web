...
import L1Tabs from './base/L1Tabs' // tabs
import L2Tabs from './base/L2Tabs' // tabs
import basePanel from './base/basePanel' // tabs
// import tabitem from './base/tabitem' // tabitem

import TabShow from './base/LeftTabs/TabShow' // tabs
import Table from './base/LeftTabs/Table' // tabs
import Contamination from './base/LeftTabs/Contamination' // tabs
const components = {
  bgAnimation,
  modal,
  sinan,
